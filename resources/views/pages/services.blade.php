    ...
    <section class="page-hero">
        <div class="container">
            <div class="page-hero-content">
                ...
                <h1 class="page-hero-title fw-bold mb-4">Technology services built for <span class="text-brand">business growth</span>.</h1>
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-6" id="software-services">
                    <div class="service-card rounded-4 p-4 p-lg-5 h-100 bg-white">
